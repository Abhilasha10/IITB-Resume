...
\item Headline Prediction from News Articles \\ 
    ...
    % \item Used existing state of the art models like Google’s Pointer Generator Network and Facebook’s NAMAS.
...
% \\ {\emph{(CS725: Foundations of Machine Learning, Prof. Ganesh Ramakrishnan)}}
    \\ [-0.6cm]
    % \begin{itemize}\itemsep \isep
    % \item Used classifiers like Decision Tree, Random Forests and Multi-Class Neural Network to classify music genres.
...
\item Low Cost Solution for Car Heating Problem
% \\ {\emph{(Design Project, Prof. Saket Saurav)}}
    % \\ [-0.6cm]
    % \begin{itemize}\itemsep \isep
...
\begin{itemize}
  ...
  \item \textbf{Tools \& Frameworks}: Git, \LaTeX, Beamer, Keras, Laravel, Django, Ansible\\[-0.6cm]
\end{itemize}
% %}}}
% \vspace{0.2cm}
...
%                 \item Responsible for writing deployment scripts of several projects.
...
%         \begin{itemize}
%                 \item Responsible for mentoring 5 postgraduate students during their freshmen year.
%         \end{itemize}
%     \item \textbf{Student Companion }\emph{(Student Counselling Services, IIIT Jabalpur)}\hfill {\emph{(Aug 2014-July 2015)}} \\[-0.6cm]
%         \begin{itemize}
%                 \item Responsible for mentoring 5 undergraduate students during their sophomore year.
%         \end{itemize}
%     \item \textbf{Student Companion }\emph{(Student Counselling Services, IIIT Jabalpur)}\hfill {\emph{(Aug 2013-Jul 2014)}} \\[-0.6cm]
%         \begin{itemize}
%                 \item Responsible for mentoring 5 undergraduate students during their freshmen year.
%         \end{itemize}
% \end{itemize}
%}}}
